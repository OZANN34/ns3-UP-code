/*  THIS CODE IS THE MODIFIED VERSION OF epc-sgw-application.cc
/*  FOR DYNAMIC REPLICATION PROCESS OF THE USER PLANE
/*  IN THE PAPER "Enhancing the Capabilities of Mobile Backhaul: A User Plane Perspective"
/*  
